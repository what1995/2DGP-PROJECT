...
class StandState:
    ...
    @staticmethod
    def do(iku):
        global ationcheak,damagecheak,ation
...
class Enemy_Iku:
    ...
    def __init__(self):
        ...
        self.skill1_sound = load_wav('./voice/iku-skill1.wav')
        self.skill1_sound.set_volume(50)
        self.skill2_sound = load_wav('./voice/iku-skill2.wav')
        self.skill2_sound.set_volume(50)
        self.skill3_sound = load_wav('./voice/iku-skill3.wav')
        self.skill3_sound.set_volume(50)
        self.last_sound = load_wav('./voice/iku-Last.wav')
        self.last_sound.set_volume(50)
        self.damage_sound = load_wav('./voice/iku-damage.wav')
        self.damage_sound.set_volume(30)
        self.down_sound = load_wav('./voice/iku-down.wav')
        self.down_sound.set_volume(70)
        self.item_sound = load_wav('./voice/iku-item.wav')
