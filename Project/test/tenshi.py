...
class Item_Doll:
    ...
    def draw(tenshi):
        if tenshi.motion == 7:
            tenshi.item_use.clip_draw(0, 0, 40, 65, 200, 280)
            tenshi.skill2.clip_draw(tenshi.Skill2frame1[int(tenshi.frame1)], 115,tenshi.Skill2frame2[int(tenshi.frame2)], 115, tenshi.x, tenshi.y)
class Item_Potion:
    @staticmethod
    def enter(tenshi, event):
    ...
    def draw(tenshi):
        if tenshi.motion == 8:
            tenshi.item_use.clip_draw(40, 0, 40, 65, 200, 280)
            tenshi.skill2.clip_draw(tenshi.Skill2frame1[int(tenshi.frame1)], 115,tenshi.Skill2frame2[int(tenshi.frame2)], 115, tenshi.x, tenshi.y)
...
class Item_Clock:
    ...
    def draw(tenshi):
        if tenshi.motion == 9:
            tenshi.item_use.clip_draw(80, 0, 40, 65, 200, 280)
            tenshi.skill2.clip_draw(tenshi.Skill2frame1[int(tenshi.frame1)], 115,tenshi.Skill2frame2[int(tenshi.frame2)], 115, tenshi.x, tenshi.y)
next_state_table = {
...
class Tenshi:
    ...
    def __init__(self):
        ...
        self.skill1_sound = load_wav('./voice/tenshi-skill1.wav')
        self.skill1_sound.set_volume(50)
        self.skill2_sound = load_wav('./voice/tenshi-skill2.wav')
        self.skill2_sound.set_volume(50)
        self.skill3_sound = load_wav('./voice/tenshi-skill3.wav')
        self.skill3_sound.set_volume(50)
        self.last_sound = load_wav('./voice/tenshi-Last.wav')
        self.last_sound.set_volume(50)
        self.damage_sound = load_wav('./voice/tenshi-damage.wav')
        self.damage_sound.set_volume(30)
        self.down_sound = load_wav('./voice/tenshi-down.wav')
        self.down_sound.set_volume(70)
        self.item_sound = load_wav('./voice/tenshi-item.wav')
