...
class Item_Doll:
    ...
    def draw(reimu):
        if reimu.motion == 7:
            reimu.item_use.clip_draw(0, 0, 40, 65, 200, 280)
            reimu.skill2.clip_draw(reimu.Skill2frame1[int(reimu.frame1)], 155, reimu.Skill2frame2[int(reimu.frame2)],120, reimu.x, reimu.y)
class Item_Potion:
    @staticmethod
    def enter(reimu, event):
    ...
    def draw(reimu):
        if reimu.motion == 8:
            reimu.item_use.clip_draw(40, 0, 40, 65, 200, 280)
            reimu.skill2.clip_draw(reimu.Skill2frame1[int(reimu.frame1)], 155, reimu.Skill2frame2[int(reimu.frame2)],120, reimu.x, reimu.y)
...
class Item_Clock:
    ...
    def draw(reimu):
        if reimu.motion == 9:
            reimu.item_use.clip_draw(80, 0, 40, 65, 200, 280)
            reimu.skill2.clip_draw(reimu.Skill2frame1[int(reimu.frame1)], 155, reimu.Skill2frame2[int(reimu.frame2)],120, reimu.x, reimu.y)
next_state_table = {
...
class Reimu:
    ...
    def __init__(self):
        ...
        self.skill1_sound = load_wav('./voice/reimu-skill1.wav')
        self.skill1_sound.set_volume(50)
        self.skill2_sound = load_wav('./voice/reimu-skill2.wav')
        self.skill2_sound.set_volume(50)
        self.skill3_sound = load_wav('./voice/reimu-skill3.wav')
        self.skill3_sound.set_volume(50)
        self.last_sound = load_wav('./voice/reimu-Last.wav')
        self.last_sound.set_volume(50)
        self.damage_sound = load_wav('./voice/reimu-damage.wav')
        self.damage_sound.set_volume(30)
        self.down_sound = load_wav('./voice/reimu-down.wav')
        self.down_sound.set_volume(70)
        self.item_sound = load_wav('./voice/reimu-item.wav')
