...
def enter():
    ...
    Main= load_image('./FCGimage/Main.png')
    logo = load_image('./FCGimage/BackGround logo.png')
    BGbamboo = load_image('./FCGimage/BGbamboo.png')
    BGHakureiShrine = load_image('./FCGimage/BGHakurei Shrine.png')
    BGclocktower = load_image('./FCGimage/BGclock tower.png')
    minibamboo = load_image('./FCGimage/minibamboo.png')
    miniHakureiShrine = load_image('./FCGimage/miniHakurei Shrine.png')
    miniclocktower = load_image('./FCGimage/miniclock tower.png')
    cheak = load_image('./FCGimage/Character_Cheak.png')
    Level = load_image('./FCGimage/Level.png')
    Level_Nomal = load_image('./FCGimage/Level-Nomal.png')
    Level_Hard = load_image('./FCGimage/Level-hard.png')
    Level_cheak = 1
